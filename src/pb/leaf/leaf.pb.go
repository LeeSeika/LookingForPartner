...
func file_leaf_leaf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_leaf_leaf_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*NextSegmentRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_leaf_leaf_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*NextSegmentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
