...
type VoteServiceClient interface {
	GetVoteData(ctx context.Context, in *GetVoteDataRequest, opts ...grpc.CallOption) (*GetVoteDataResponse, error)
...
func (c *voteServiceClient) GetVoteData(ctx context.Context, in *GetVoteDataRequest, opts ...grpc.CallOption) (*GetVoteDataResponse, error) {
	out := new(GetVoteDataResponse)
	err := c.cc.Invoke(ctx, "/VoteService/GetVoteData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voteServiceClient) Vote(ctx context.Context, in *VoteRequest, opts ...grpc.CallOption) (*VoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/VoteService/Vote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VoteServiceServer interface {
	GetVoteData(context.Context, *GetVoteDataRequest) (*GetVoteDataResponse, error)
...
func (UnimplementedVoteServiceServer) GetVoteData(context.Context, *GetVoteDataRequest) (*GetVoteDataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetVoteData not implemented")
}
...
func _VoteService_GetVoteData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVoteDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VoteServiceServer).GetVoteData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/VoteService/GetVoteData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).GetVoteData(ctx, req.(*GetVoteDataRequest))
	}
...
var VoteService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetVoteData",
			Handler:    _VoteService_GetVoteData_Handler,
		},
		{
			MethodName: "Vote",
